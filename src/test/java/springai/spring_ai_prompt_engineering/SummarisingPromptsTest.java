...
@SpringBootTest
public class SummarisingPromptsTest extends BaseTestClass {
    ...
    @Test
    void testBookReviewSummarization1() {
        PromptTemplate promptTemplate = new PromptTemplate(reviewPrompt);
        Prompt prompt = promptTemplate.create(Map.of("review", review1));
    ...
    @Test
    void testBookReviewSummarization3() {
