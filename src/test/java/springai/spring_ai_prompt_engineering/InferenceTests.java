...
public class InferenceTests extends BaseTestClass {
    ...
    @DisplayName("Infering Sentiment")
    @Test
    ...
    @DisplayName("Infering Emotion")
    @Test
    void testEmotionAnalysis() {
    ...
    @DisplayName("Infering Anger")
    @Test
    void testAngerAnalysis() {
    ...
    @DisplayName("Infering Topics")
    @Test
    void testTopicAnalysis(@TempDir java.nio.file.Path tempDir) {
        PromptTemplate promptTemplate = new PromptTemplate(inferingTopicsPrompt);
        Prompt prompt = promptTemplate.create(Map.of(
                "story", story
        ));
        ChatResponse response = chatModel.call(prompt);
